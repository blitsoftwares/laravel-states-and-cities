        ...
        <div class="panel-body">
            <form class="form-horizontal" method="POST" action="{{ route('countries.store') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input id="code_iso2" name="code_iso2" type="text" class="form-control" value="{{ old('code_iso2') }}" maxlength="2" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input id="code_iso3" name="code_iso3" type="text" class="form-control" maxlength="3"  value="{{ old('code_iso3') }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="code_phome" class="col-md-4 control-label">{{ trans('StatesAndCities::countries.fields.code_phone') }}</label>
                    <div class="col-md-2">
                        <input id="code_phone" name="code_phone" type="text" class="form-control"  value="{{ old('code_phone') }}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="lang" class="col-md-4 control-label">{{ trans('StatesAndCities::countries.fields.lang') }}</label>
                    <div class="col-md-2">
                        <input id="lang" name="lang" type="text" class="form-control"  value="{{ old('lang') }}">
                    </div>
                </div>
